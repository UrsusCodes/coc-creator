...
import { ArrowLeft, Save, Loader2, Pencil, X, Clock, CheckCircle, XCircle } from 'lucide-react'
import { usePlayerStore } from '@/stores/playerStore'
import { playerProposeEdit, playerGetPending, playerCancelPending } from '@/lib/player'
